...
namespace Valres\CoreKitmap\libs\customies\item;

use Valres\CoreKitmap\libs\customies\item\component\AllowOffHandComponent;
use Valres\CoreKitmap\libs\customies\item\component\CanDestroyInCreativeComponent;
use Valres\CoreKitmap\libs\customies\item\component\CooldownComponent;
use Valres\CoreKitmap\libs\customies\item\component\CreativeCategoryComponent;
use Valres\CoreKitmap\libs\customies\item\component\CreativeGroupComponent;
use Valres\CoreKitmap\libs\customies\item\component\DamageComponent;
use Valres\CoreKitmap\libs\customies\item\component\DisplayNameComponent;
use Valres\CoreKitmap\libs\customies\item\component\DurabilityComponent;
use Valres\CoreKitmap\libs\customies\item\component\FoodComponent;
use Valres\CoreKitmap\libs\customies\item\component\FuelComponent;
use Valres\CoreKitmap\libs\customies\item\component\HandEquippedComponent;
use Valres\CoreKitmap\libs\customies\item\component\IconComponent;
use Valres\CoreKitmap\libs\customies\item\component\ItemComponent;
use Valres\CoreKitmap\libs\customies\item\component\MaxStackSizeComponent;
use Valres\CoreKitmap\libs\customies\item\component\ProjectileComponent;
use Valres\CoreKitmap\libs\customies\item\component\RenderOffsetsComponent;
use Valres\CoreKitmap\libs\customies\item\component\ThrowableComponent;
use Valres\CoreKitmap\libs\customies\item\component\UseAnimationComponent;
use Valres\CoreKitmap\libs\customies\item\component\UseDurationComponent;
use Valres\CoreKitmap\libs\customies\item\component\WearableComponent;
use Valres\CoreKitmap\libs\customies\util\NBT;
	...
	public function getComponents(): CompoundTag {
		...
		foreach($this->components as $component){
			...
			if($component->isProperty()) {
				$properties->setTag($component->getName(), $tag ?? CompoundTag::create());
				continue;
			}
