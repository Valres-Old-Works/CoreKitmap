...
namespace Valres\CoreKitmap\libs\customies\block;

use Closure;
use Valres\CoreKitmap\libs\customies\block\permutations\Permutable;
use Valres\CoreKitmap\libs\customies\block\permutations\Permutation;
use Valres\CoreKitmap\libs\customies\block\permutations\Permutations;
use Valres\CoreKitmap\libs\customies\item\CreativeInventoryInfo;
use Valres\CoreKitmap\libs\customies\item\CustomiesItemFactory;
use Valres\CoreKitmap\libs\customies\task\AsyncRegisterBlocksTask;
...
final class CustomiesBlockFactory
{
	...
	public function registerBlock(Closure $blockFunc, string $identifier, ?Model $model = null, ?CreativeInventoryInfo $creativeInfo = null, ?Closure $serializer = null, ?Closure $deserializer = null): void {
		...
		$this->customBlocks[str_replace("highcraft:", "", $identifier)] = $block;
